...
export enum LiquidityProviders {
  ...
  AerodromeSlipstreamV2_1 = 'AerodromeSlipstreamV2_1',
  AerodromeSlipstreamV2_2 = 'AerodromeSlipstreamV2_2',
  VelodromeSlipstream = 'VelodromeSlipstream',
  VelodromeSlipstreamV2 = 'VelodromeSlipstreamV2',
  NileV2 = 'NileV2',
  NileV3 = 'NileV3',
  KodiakV2 = 'KodiakV2',
  KodiakV3 = 'KodiakV3',
...
export const UniV3LiquidityProviders: LiquidityProviders[] = [
  ...
  LiquidityProviders.AerodromeSlipstreamV2_1,
  LiquidityProviders.AerodromeSlipstreamV2_2,
  LiquidityProviders.VelodromeSlipstream,
  LiquidityProviders.VelodromeSlipstreamV2,
